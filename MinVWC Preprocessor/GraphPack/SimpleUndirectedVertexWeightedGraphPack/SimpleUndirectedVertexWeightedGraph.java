...
public class SimpleUndirectedVertexWeightedGraph{
	...
	{
			System.out.println("File Name: " + instance_file_name);
			vertex_num = 0; 
			edge_num = 0;
			// open the input file
			...
			try{// catch(FileNotFoundException e)			
				...
				{
					vertices[i] = new WeightedVertex(null, null, 0, 0);
				}
...
//if(i % 10000 == 0) System.out.println(i + " e lines have been read");
				...
				{
					if(v_degree_tmp[v] > max_degree)
						max_degree = v_degree_tmp[v];
				}
				...
				// establish neighbor data structures
				for(int v = 1; v <= vertex_num; v++)
				{
					v_degree_tmp[v] = 0;
				}				
